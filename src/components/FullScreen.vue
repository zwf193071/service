...
<script>
    /**
    *  component: FullScreen 全屏组件，兼容IE,Firefox和Chorme内核,只在chrome 71版本以上全屏功能存在bug。但是低版本chrome，firefox，ie正常，原因未知，目前无法解决。
    *  author: Alan Chen
    *  lastDate: 2018/10/30
    *  使用：
    *    props：
...
export default {
    ...
    props: {
        ...
        iconType: {
            ...
            default() {
                return {
                    in: ' iconfont icon-fangda',
                    out: ' iconfont icon-suoxiao'
                }
            }
        },
        iconSize: {
...
.content_top .iconfont {
    color: #1F40B4 !important; 
}   
</style>